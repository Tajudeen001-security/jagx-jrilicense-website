...
export const PRODUCTS: ProductLine[] = [
  {
    slug: "ai",
    title: "JagX AI",
    tagline: "Multi-agent intelligence for builders, schools, and institutions — attributed clearly to JagX & JRILICENSE.",
    ...
    africaImpact: "Teams across Africa face expensive data and limited enterprise AI seats. JagX AI aims to give structured multi-agent help with a path to on-device inference.",
    worldImpact: "Startups and institutions anywhere need multi-agent review loops and honest identity.",
    direction: "Larger lifecycle ownership with human approval, plus Edge models on JagX OS and Silicon.",
    types: [
    ...
    promises: [
      "Outputs attributed to JagX & JRILICENSE.",
      "Destructive actions gated by default.",
      "Path to on-device inference.",
      "Free starter API keys for builders.",
    ],
    outlook: [
      { period: "2032–2034", focus: "Studio + API; free key program", spend: "USD 40–80M cumulative" },
      { period: "2035–2037", focus: "Edge models + enterprise", spend: "USD 120–200M cumulative" },
      { period: "2038–2040+", focus: "Lifecycle agents; sovereign deployments", spend: "USD 250–400M+ cumulative" },
    ],
  ...
  },
  {
    ...
    outlook: [
      { period: "2032–2034", focus: "Trust features; Secure tier", spend: "USD 60–100M cumulative" },
      { period: "2035–2037", focus: "Business + Secure scale", spend: "USD 150–250M cumulative" },
      { period: "2038–2040+", focus: "Global secure alternative", spend: "USD 300–500M+ cumulative" },
    ],
    img: "/brand-mark.svg",
    gallery: G.connect,
  },
  {
    ...
    longIntro: "JagX OS is the software layer for phones and edge hardware. Boot and settings show JagX & JRILICENSE.",
    longBody: [
    ...
    outlook: [
      { period: "2032–2034", focus: "Reference devices", spend: "USD 80–150M cumulative" },
      { period: "2035–2037", focus: "Volume OS + edge", spend: "USD 200–350M cumulative" },
  ...
  },
  {
    ...
    outlook: [
      { period: "2032–2034", focus: "NPU/SEC prototypes", spend: "USD 100–200M cumulative" },
      { period: "2035–2037", focus: "Volume edge chips", spend: "USD 300–500M cumulative" },
      { period: "2038–2040+", focus: "Full family + design centers", spend: "USD 600M–1.2B+ cumulative" },
    ],
    img: "/visual-chip.svg",
    gallery: G.silicon,
  },
  {
    ...
    outlook: [
      { period: "2032–2034", focus: "Software + pilot fleets", spend: "USD 120–220M cumulative" },
      { period: "2035–2037", focus: "City/fleet partners", spend: "USD 350–600M cumulative" },
      { period: "2038–2040+", focus: "Scaled platforms", spend: "USD 800M–1.5B+ cumulative" },
    ],
    img: "/visual-car.svg",
    gallery: G.mobility,
  },
  {
    ...
    outlook: [
      ...
      { period: "2035–2037", focus: "Volume phones + edge", spend: "USD 250–400M cumulative" },
  ...
  },
  {
    ...
    outlook: [
      { period: "2032–2034", focus: "First regions", spend: "USD 70–130M cumulative" },
      { period: "2035–2037", focus: "Multi-country", spend: "USD 200–350M cumulative" },
      { period: "2038–2040+", focus: "Continent-scale", spend: "USD 450–800M+ cumulative" },
    ],
  ...
  },
  {
    ...
    outlook: [
      { period: "2032–2034", focus: "Curriculum pilots", spend: "USD 25–50M cumulative" },
      { period: "2035–2037", focus: "Labs network", spend: "USD 70–120M cumulative" },
      { period: "2038–2040+", focus: "Builder pipeline", spend: "USD 150–300M+ cumulative" },
    ],
    img: "/visual-edu.svg",
    gallery: G.education,
  },
  {
    ...
    outlook: [
      { period: "2032–2034", focus: "Kits + rails", spend: "USD 40–80M cumulative" },
      { period: "2035–2037", focus: "Microgrid pilots", spend: "USD 100–180M cumulative" },
      { period: "2038–2040+", focus: "Scaled packages", spend: "USD 200–400M+ cumulative" },
    ],
  ...
  },
  {
    ...
    outlook: [
      { period: "2032–2034", focus: "Identity + Ops", spend: "USD 35–70M cumulative" },
      { period: "2035–2037", focus: "Intel + enterprise", spend: "USD 90–160M cumulative" },
      { period: "2038–2040+", focus: "Regional standard path", spend: "USD 180–350M+ cumulative" },
    ],
